module.exports = {
    history: getHistory(),
    githubstats: getStatsFromGithub(),
    DBstats: getStatsFromDB()
};

function getHistory(id) {
    console.log("get history from id: " + id);
}

function getStatsFromGithub(username, repo) {
    console.log("Get stats from Github repo: " + username + "/" + repo);
}

function getStatsFromDB(id) {
    console.log("get stats from DB of id: " + id);
}
